...
from utils.config import DISCORD_BOT_TOKEN, DISCORD_GUILD_ID, logging
...
# )
intents = discord.Intents(guilds=True, messages=True, message_content=True,) #TODO testing
